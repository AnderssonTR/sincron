...
from gestionClientes.models import GestionCliente
...
class Usuario(models.Model):
    ...
    usuarioActivo=models.CharField(max_length=1,choices=Estado.choices, default=Estado.activo, verbose_name="Estado" )
...
class MonitorEstado(models.Model):
    class Periodo(models.TextChoices):
        ...
        mes='MES',_('Mes')
    monitorEstadoPeriodo=models.CharField(max_length=10,choices=Periodo.choices, default=Periodo.semana, verbose_name="Periodo de tiempo")
    ...
    class Estado(models.TextChoices):
        activo='1',_('Activo')
        inactivo='0',_('Inactivo')
    monitorEstadoActivo=models.CharField(max_length=1,choices=Estado.choices, default=Estado.activo, verbose_name="Estado" )
